  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col md:flex-row">
      <nav className="w-full md:w-20 lg:w-64 bg-zinc-950 border-r border-white/5 flex md:flex-col items-center justify-around md:justify-start py-2 md:py-10 gap-0 md:gap-3 sticky top-0 h-16 md:h-screen z-50 order-2 md:order-1 overflow-y-auto">
        ...
        <NavItem mode={ViewMode.REMOTE_DESKTOP} label="Remote Desktop" icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>} />
        ...
        <NavItem mode={ViewMode.VMS} label="Virtualization" icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>} />
        ...
        <NavItem mode={ViewMode.LOGS} label="System Logs" icon={<svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>} />
      ...
      <main className="flex-1 min-h-screen order-1 md:order-2 overflow-y-auto">
        <header className="px-10 py-6 border-b border-white/5 bg-zinc-950/50 backdrop-blur sticky top-0 z-40 flex justify-between items-center">
          <h1 className="text-xl font-bold tracking-tight">rTechManager<span className="text-zinc-500 text-[10px] ml-2 italic tracking-widest uppercase">Infrastructure Suite</span></h1>
          <div className="flex items-center gap-6">
            ...
            <div className="text-right">
              ...
              <span className="text-[9px] text-green-500 font-mono uppercase">System Active</span>
            </div>
          </div>
        </header>
